...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    {
        [TestMethod]
        public async Task ObtenerPersonasPaginas()
        {
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActorCreacionDTO() { Nombre = "Luis", FechaNacimiento = DateTime.Now };
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            var actor = new Actor() { Nombre = "Luis", FechaNacimiento = fechaNacimiento };
            contexto.Add(actor);
            await contexto.SaveChangesAsync();
            ...
            var patchDoc = new JsonPatchDocument<ActorPatchDTO>();
            patchDoc.Operations.Add(new Operation<ActorPatchDTO>("replace", "/nombre", null, "Lucas"));
            var respuesta = await controller.Patch(1, patchDoc);
            var resultado = respuesta as StatusCodeResult;
            ...
            Assert.AreEqual("Lucas", actorDB.Nombre);
